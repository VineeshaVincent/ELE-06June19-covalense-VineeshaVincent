...
@Log
public class EmployeeExperienceJob {
public static void main(String[] args) {
	...
	arrlist.add(emp4);
	arrlist.add(emp5);
	List<EmployeeExperience>list =arrlist.stream().filter(i->(i.getExperience()>2&&i.getDesignation()=="software engineer")).collect(Collectors.toList());
	for(EmployeeExperience EmployeeExperience:list) {
		log.info("employee who has more than 2 years experience with job type are:"+EmployeeExperience);
	}
